...
with gr.Blocks(title=brand_info['organizationName']) as demo:
    ...
    gr.ChatInterface(
        ...
        chatbot=gr.Chatbot(height=500, avatar_images=(None, brand_info['chatbot']['avatar'])), # Configure chatbot display
...
if __name__ == "__main__":
    ...
    demo.launch(theme="default", quiet=True) # Launch the demo without a specific favicon path (handled by browser)